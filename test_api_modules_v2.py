...
def main():
    print("Starting module-specific API test (v2)...")
    ...
    if auth_response.status_code == 200:
        ...
        endpoint_patterns = [
            ...
            "/c/{module}/timeregistration",
            "/c/api/v1/{module}/timeregistration",
            "/c/api/v2/{module}/timeregistration",
            "/c/api/v1/module/{module}/timeregistration",
            "/c/api/v2/module/{module}/timeregistration",
            "/c/datawarehouse/{module}/timeregistration",
            "/c/datawarehouse/api/{module}/timeregistration"
        ]
